...
def thetascan(thetapts,motor1,startpos1,endpos1,numpts1,motor2,startpos2,endpos2,numpts2,dettime):
	...
	for ii in range(numthpts):
		...
		epics.caput("26idbSOFT:scan1.REFD",35); #Set horizontal reference XRF detector channel (35 = Si, 28 = I)
		...
		#time.sleep(1)
		sc1.PASM = 6  #Sets lineup scan to post-scan move to center of mass (7) or peak (3), -edge (6)
		print("scanning hybridx to recenter")
		_hx0 = epics.caget("26idcnpi:X_HYBRID_SP.VAL")
		#movr(hybridx,-10)
		xscan=20;
		scan1d(hybridx,-xscan/2,xscan/2, 101, 0.3)  # ADJUST X LINE UP SCAN HERE
		...
		#scan1d(motor1, startpos1, endpos1, numpts1, dettime)
...
def Overnight20191211():
	thetascan([11.2, 11.3, 11.5], hybridy, -18, 2, 41, hybridx, -1, 3.09, 41, 1) #finish up coarse RC1
	thetascan([11.2, 11.3, 11.4, 11.5, 11.6], hybridy, -5.5, 4.5, 51, hybridx, 1.3, 3.29, 51, 1) #.2um scan in subset of RC1
