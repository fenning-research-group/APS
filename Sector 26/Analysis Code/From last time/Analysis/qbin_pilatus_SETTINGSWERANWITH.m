function dataout = qbin_pilatus(imname, Tthdet, Rdet, Gamdet, Xdet,Ydet,Samth, Samchi, Samphi, plotflag)
...
% lat = [8.207 8.255 11.759]; % CsPbBr3 ortho lattice vectors a b c (A)
lat=[8.8392 8.8392 12.6948]; %I4/mcm MAPbI3
...
refl=[0 0 2; 1 1 0; 2 1 1;2 0 2; 0 0 4; 2 2 0; 1 1 4; 2 2 2; 3 1 0; 2 0 4;3 1 2; 2 2 4; 4 0 0;4 1 1;3 1 4]; %MAPI I4/mcm
...
if(nargin<7) 
    ...
    Samchi = 0; % Sample rotation about beam axis (deg, RHR)
